...
class DataLoader_bytrajec2_sdd():
    ...
    def traject_preprocess(self,setname):
        ...
        # For each dataset
        for seti,path in enumerate(data_dirs):
            delim = "space"
            ...
            for ind, pedi in enumerate(Pedlist):
                ...
                for fi,frame in enumerate(FrameList):
                    ...
                    ped_id  =FrameContainPed[1, FrameContainPed[0, :] == frame][0]
                    # Add their pedID, x, y to the row of the numpy array
                    Trajectories.append([int(frame),current_x, current_y ,ped_class,ped_frame,ped_id])
