...
def get_parser():
    parser = argparse.ArgumentParser(description='SRGAT')
    parser.add_argument(
    ...
    parser.add_argument(
        '--SA',default=True,type=ast.literal_eval)
    parser.add_argument(
        '--GS',default=True,type=ast.literal_eval)
    parser.add_argument("--pass_time",
                        default=2,
                        type=int)
    parser.add_argument("--gs_pass_time",
                        default=2,
                        type=int)
    ...
    parser.add_argument(
        '--test_set',default=9,type=int,
        help='Set this value to 0~4 for ETH-univ, ETH-hotel, UCY-zara01, UCY-zara02, UCY-univ and 9 for sdd')
    parser.add_argument(
        '--base_dir',default='.',
